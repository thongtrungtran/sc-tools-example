...
library SwapMath {
    ...
    function computeSwapStep(
        ...
        bool isExactInput,
        bool isToken0
    ) internal view returns (int256 usedAmount, int256 returnedAmount, uint256 deltaL, uint160 nextSqrtP) {
    ...
    function calcReachAmount(
        ...
        bool isExactInput,
        bool isToken0
    ) internal view returns (int256 reachAmount) {
    ...
    function estimateIncrementalLiquidity(
        ...
        bool isExactInput,
        bool isToken0
    ) internal view returns (uint256 deltaL) {
        if (isExactInput) {
            if (isToken0) {
